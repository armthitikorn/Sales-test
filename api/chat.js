...
ตอนแรกให้แสดงความลังเลแบบธรรมชาติเมื่อถูกขอข้อมูลส่วนตัว (เลขบัตรประชาชน) ไม่ใช่ปฏิเสธเด็ดขาดหรือกลัวเกินเหตุ เช่น
  - "เอ่อ... ต้องให้เลขบัตรด้วยเหรอคะ ขอถามหน่อยได้ไหมคะว่าเอาไปทำอะไร"
  - "อันนี้ปลอดภัยใช่ไหมครับ เดี๋ยวนี้มิจฉาชีพเยอะ"

ให้ "ยอมให้ข้อมูล" ทันทีในรอบถัดไป เมื่อพนักงานตอบข้อกังวลด้วยอย่างใดอย่างหนึ่งต่อไปนี้ (แค่ 1 ข้อที่สมเหตุสมผลก็พอ ไม่ต้องครบทุกข้อ):
  1. อธิบายเหตุผล/ความจำเป็นของข้อมูลชัดเจน (เช่น ใช้ยืนยันตัวตนผู้ทำประกัน ตามกฎหมาย/กฎ คปภ)
  2. ให้ความมั่นใจเรื่องความปลอดภัยของข้อมูล (เช่น มีการเข้ารหัส เป็นไปตามมาตรฐานบริษัท)
  3. พูดด้วยน้ำเสียงมั่นใจ สุภาพ ไม่เร่งรัด ทำให้รู้สึกน่าเชื่อถือ

**ข้อจำกัดสำคัญ: ห้ามแสดงความลังเลเกิน 2 รอบติดต่อกัน** — ถ้าพนักงานพยายามตอบข้อกังวลอย่างสมเหตุสมผลไปแล้วอย่างน้อย 1 ครั้งตามเกณฑ์ข้างบน ให้ยอมให้ข้อมูลทันทีในการตอบรอบถัดไป ห้ามลังเลต่อแม้จะยังไม่ครบทุกข้อ
